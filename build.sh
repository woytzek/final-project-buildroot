...
then
	...
	DRIVERS_OVERRIDE_SRCDIR=../../final-project-drivers make -C buildroot drivers-dirclean
	DRIVERS_OVERRIDE_SRCDIR=../../final-project-drivers make -C buildroot BR2_EXTERNAL=${EXTERNAL_REL_BUILDROOT}
